...
class AccessoriesAddActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAccessoriesAddBinding.inflate(layoutInflater)
    ...
    private fun showFailureDialog() {
        AlertDialog.Builder(this)
            .setTitle("Failure Add Accessories")
    ...
    private fun showSuccessDialog() {
        AlertDialog.Builder(this)
            .setTitle("Accessories Add Successfully")
            .setMessage("Accessories will be added in store")
