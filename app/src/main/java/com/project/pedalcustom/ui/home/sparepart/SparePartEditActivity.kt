...
class SparePartEditActivity : AppCompatActivity() {
    ...
    private fun formValidation() {
        ...
        if(name.isEmpty()) {
            ...
            Toast.makeText(this, "Spare Part type must be filled!", Toast.LENGTH_SHORT).show()
    ...
    private fun showFailureDialog() {
        AlertDialog.Builder(this)
            .setTitle("Failure Edit Spare Part")
    ...
    private fun showSuccessDialog() {
        AlertDialog.Builder(this)
            .setTitle("Spare Part Edit Successfully")
            .setMessage("Spare Part will be renew in store")
